...
class cl_alunos { 
   ...
   function incluir ($alu01_codigo){ 
     ...
     if($this->alu01_nome == null ){ 
       $this->erro_sql = " Campo Nome do aluno nao Informado.";
     ...
     if($this->alu01_email == null ){ 
       $this->erro_sql = " Campo Email do aluno nao Informado.";
     ...
     if($alu01_codigo == "" || $alu01_codigo == null ){
       $result = @pg_query("select nextval('alunos_alu01_codigo_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from alunos_alu01_codigo_seq");
     ...
     $result = @pg_query("insert into alunos(
                                       alu01_codigo 
                                      ,alu01_nome 
                                      ,alu01_email 
                       )
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,2024013,'$this->alu01_codigo','I')");
       $resac = pg_query("insert into db_acount values($acount,1010192,2024013,'','".pg_result($resaco,0,'alu01_codigo')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1010192,2014138,'','".pg_result($resaco,0,'alu01_nome')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1010192,2014139,'','".pg_result($resaco,0,'alu01_email')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($alu01_codigo=null) { 
     ...
     $sql .= " where  alu01_codigo = $this->alu01_codigo
";
     $resaco = $this->sql_record($this->sql_query_file($this->alu01_codigo));
     if($this->numrows>0){       $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
       $acount = pg_result($resac,0,0);
       $resac = pg_query("insert into db_acountkey values($acount,2024013,'$this->alu01_codigo','A')");
       if(isset($GLOBALS["HTTP_POST_VARS"]["alu01_codigo"]))
         $resac = pg_query("insert into db_acount values($acount,1010192,2024013,'".pg_result($resaco,0,'alu01_codigo')."','$this->alu01_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["alu01_nome"]))
         $resac = pg_query("insert into db_acount values($acount,1010192,2014138,'".pg_result($resaco,0,'alu01_nome')."','$this->alu01_nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["alu01_email"]))
         $resac = pg_query("insert into db_acount values($acount,1010192,2014139,'".pg_result($resaco,0,'alu01_email')."','$this->alu01_email',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($alu01_codigo=null) { 
     $this->atualizacampos(true);
     $resaco = $this->sql_record($this->sql_query_file($this->alu01_codigo));
     if(($resaco!=false)||($this->numrows!=0)){
       $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
       $acount = pg_result($resac,0,0);
       $resac = pg_query("insert into db_acountkey values($acount,2024013,'$this->alu01_codigo','E')");
       $resac = pg_query("insert into db_acount values($acount,1010192,2024013,'','".pg_result($resaco,0,'alu01_codigo')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1010192,2014138,'','".pg_result($resaco,0,'alu01_nome')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1010192,2014139,'','".pg_result($resaco,0,'alu01_email')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     $sql = " delete from alunos
                    where ";
     $sql2 = "";
      if($this->alu01_codigo != ""){
      if($sql2!=""){
        $sql2 .= " and ";
      }
      $sql2 .= " alu01_codigo = $this->alu01_codigo ";
}
